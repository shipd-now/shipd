...
# Marker-owned files generated by earlier registry versions. Generation and
# removal use this data to retire moved user surfaces without touching foreign
# files at the same paths.
LEGACY_USER_PATTERNS = {
    "agy": ("~/.gemini/antigravity-cli/skills/shipd-{command}.md",),
}
...
HARNESSES = (
    ...
    },
    {
        ...
        "repo_pattern": ".agents/skills/shipd-{command}/SKILL.md",
        "user_dir": "~/.gemini/config/skills/shipd-{command}/",
        "dialect": "yaml",
