...
- **THEN** stdout contains all thirteen registry ids and the exit code is 0
...
- **THEN** stdout parses as JSON with thirteen entries whose ids match
  `ids()`
