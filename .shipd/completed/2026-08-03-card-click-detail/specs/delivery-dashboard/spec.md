...
via footer-bound keys, open a **modal detail screen** for the focused member
...
- **THEN** the same modal detail screen for that member is pushed onto the screen
  stack, and the clicked card holds focus
